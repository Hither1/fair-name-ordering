...
from grandpiper.Reed_Solomon.ff import GF256int
from grandpiper.Reed_Solomon.polynomial import Polynomial

"""This module implements Reed_Solomon Encoding.
...
class RSCoder(object):
    def __init__(self, n, k):
        """Creates a new Reed_Solomon Encoder/Decoder object configured with
